  ...
  return (
    <Layout title="Presupuesto">
      ...
      <div style={{ background: '#4361EE', borderRadius: 16, padding: '22px 26px', position: 'relative', overflow: 'hidden' }}>
        ...
        {/* Layout: izquierda título+botones | derecha KPIs 2×2 */}
        <div style={{ display: 'flex', gap: 24, alignItems: 'flex-start' }}>
          ...
          <div style={{ flex: '0 0 auto', minWidth: 200 }}>
            ...
            <div style={{ fontSize: 18, fontWeight: 700, color: '#fff', letterSpacing: '-0.3px', marginBottom: 20 }}>
          ...
          {/* Divisor vertical */}
          <div style={{ width: '1px', background: 'rgba(255,255,255,0.18)', alignSelf: 'stretch', flexShrink: 0 }} />

          {/* Derecha: KPIs en grid 2×2 */}
          <div style={{ flex: 1, display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
            {[
              ...
              <div key={i}>
                ...
                {(k as any).esAlertas ? (
                  <>
                    <div style={{ fontSize: 22, fontWeight: 400, color: '#fff', letterSpacing: '-0.5px', marginBottom: 6 }}>
                      {sobrePlan + bajoPlan}
                    </div>
                  ...
                  <>
                    <div style={{ display: 'flex', alignItems: 'baseline', gap: 8, marginBottom: 5, flexWrap: 'wrap' }}>
                      <span style={{ fontSize: 22, fontWeight: 400, color: '#fff', letterSpacing: '-0.5px' }}>{fmtK(k.plan!)}</span>
                      {(k.real ?? 0) > 0 && <span style={{ fontSize: 12, color: 'rgba(255,255,255,0.6)' }}>{fmtK(k.real!)}</span>}
                    </div>
                    {(k.real ?? 0) > 0 && (() => {
