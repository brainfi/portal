...
export default function Sidebar() {
  ...
  return (
    <aside style={{ width:210, background:'#fff', borderRight:'1px solid #EAECF0', display:'flex', flexDirection:'column', flexShrink:0, height:'100vh', position:'sticky', top:0 }}>

      {/* Logo */}
      <div style={{ padding:'20px 18px 16px', borderBottom:'1px solid #EAECF0', display:'flex', alignItems:'center', gap:8 }}>
        ...
        {navGroups.map(group => (
          <div key={group.section}>
            ...
            {group.items.map(item => {
              ...
              return (
                <button key={item.label} onClick={() => !item.disabled && navigate(item.path)}
      ...
      <div style={{ padding:12, borderTop:'1px solid #EAECF0' }}>
        <div style={{ display:'flex', alignItems:'center', gap:8, padding:'8px 6px', borderRadius:8, cursor:'pointer' }}>
