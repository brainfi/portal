      ...
      <div key={i} style={{ paddingLeft: i > 0 ? 24 : 0, borderLeft: i > 0 ? '1px solid rgba(255,255,255,0.15)' : 'none' }}>
          ...
          <div style={{ display: 'flex', gap: 8, alignItems: 'center', flexWrap: 'wrap' }}>
            ...
            <div style={{ position: 'relative' }}>
              <button onClick={() => setDropdownOpen(o => !o)} style={{
                ...
                borderRadius: 9, background: 'rgba(255,255,255,0.15)', color: '#fff',
            ...
            <button onClick={() => setModalNueva(true)} style={{
              ...
              fontSize: 12, fontWeight: 600, border: 'none', borderRadius: 9,
              background: '#fff', color: '#4361EE', cursor: 'pointer', fontFamily: 'Inter,sans-serif',
            }}>
              <i className="ti ti-plus" style={{ fontSize: 13 }} aria-hidden="true" />
              Nueva línea
            </button>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 0, marginTop: 20, paddingTop: 18, borderTop: '1px solid rgba(255,255,255,0.15)' }}>
          {[
            ...
            <div key={i} style={{ paddingLeft: i > 0 ? 24 : 0, borderLeft: i > 0 ? '1px solid rgba(255,255,255,0.15)' : 'none' }}>
              <div style={{ fontSize: 9, fontWeight: 600, color: 'rgba(255,255,255,0.5)', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: 5 }}>
                {k.lbl}
              </div>
              {(k as any).esAlertas ? (
                <div style={{ display: 'flex', gap: 6, alignItems: 'center', flexWrap: 'wrap' }}>
