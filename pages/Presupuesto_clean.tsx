  ...
  return (
    <Layout title="Presupuesto">
      ...
      <div style={{ background:'#4361EE', borderRadius:16, padding:'20px 24px', position:'relative', overflow:'hidden' }}>
        ...
        <div className="pres-kgrid" style={{ display:'grid', gridTemplateColumns:'repeat(4,1fr)', gap:0, paddingTop:18, borderTop:'1px solid rgba(255,255,255,0.15)' }}>
          {([
            ...
            { lbl:'Alertas',         plan:0,            real:0,            tipo:'ingreso' as TipoPartida, esAlertas:true },
          ] as const).map((k, i) => (
            <div key={i} style={{ paddingLeft:i > 0 ? 24 : 0, borderLeft:i > 0 ? '1px solid rgba(255,255,255,0.15)' : 'none' }}>
              ...
              {k.esAlertas ? (
                ...
                <div style={{ display:'flex', alignItems:'baseline', gap:8, flexWrap:'wrap' }}>
                  ...
                  {k.real > 0 && <span style={{ fontSize:12, color:'rgba(255,255,255,0.55)' }}>{fmtK(k.real)}</span>}
                  {k.real > 0 && (() => {
