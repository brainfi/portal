  ...
  return (
    <div style={{ display: 'flex', height: '100vh', overflow: 'hidden', fontFamily: 'Inter, sans-serif' }}>
      ...
      <div style={{
        ...
        {/* Mockup */}
        <div style={{ width: '100%', maxWidth: 420, background: 'rgba(255,255,255,0.1)', borderRadius: 16, border: '1px solid rgba(255,255,255,0.15)', padding: 20, backdropFilter: 'blur(10px)', marginBottom: 32 }}>
